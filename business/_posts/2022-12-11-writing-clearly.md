...
related:
- business/_posts/2022-12-12-finer-points-of-writing-clearly.md
toc: true
tags:
  - writing
  - communication
...
{% include show-image.html src="/assets/img/blog/pyramid_brain.gif" caption="Created by author using PowerPoint" alt="A conceptual model of short-term memory processing of brain" %}
...
At this point my heart is racing and my mind is going through multiple questions, *did the second sample show something wrong? Is everything alright?*  
**Doctor's assistent continues:** *Thankfully, the results are ok with the second sample also. So you are clear.*  
**Consider the alternative message:** *Manohar, happy to tell you that your second blood sample results also show everything is ok. Thank you for coming a second time, we just wanted to be sure.*  

Starting with the answer gets the message across faster and prepares the reader for the details.

## The Pyramid Structure 
In the pyramid, **you lead with the answer – the main message.** You expand the pyramid vertically by answering the **why** and **how** questions raised in the reader's mind and explain your logic horizontally using deductive or inductive arguments. Thus, the elements in the pyramid have both a vertical and horizontal relationship. The first level of hierarchy from the main message is the key-line level. At this level, you must cover the "why" of the main message. Lower levels serve the details supporting the key-line levels. The pyramid should be preceded by an introduction, describing what the reader will get and why they should care. 
...
An exciting implication of the question/answer dialogue is that it eliminates any logical need for a conclusion. Logically speaking, there is no more to say once all questions have been answered. But a conclusion creates a sense of closure; without it, we would have no place for the inevitable Next Steps. So you may summarize the key-points and include next steps at the end. Nonetheless, there is no such thing as a structured conclusion.  

You can apply the pyramid principle to day-to-day chats and emails as well. Notice the leading with main message, and the importance of order in this dialog with Laura:
>**Laura:** *I have a question on "Field A" in System A. Is it equivalent to "Field B" in system B?*  
**My first draft:** *Yes, they are the same. There could be marginal differences in counts between systems due to the time when systems refresh, but both systems source data from the same field in System C.*  
When I reviewed the draft, I found that although I had answered the first question, the following statement called out differences, then I switched back to saying they are same. So Laura would have to read: **same, different, and same**. Secondly, I drew attention to the less critical element – the minor differences - first.  
...
3.	In the top box of the pyramid, write the answer or the resolution - the main message.
...
8.	How will you answer it? Will you use Deductive reasoning or Inductive reasoning?
9.	Repeat the question-answer process to structure the support points.  

The bottoms-up approach is very valuable for presenting output from research or audit projects. In my experience, this approach takes longer, especially when multiple groups are involved, because it is challenging to decide what to cut. 
...
4.  Think through the top-down approach and verify that vertical structure raises and answers the "Why" and "How" questions.

Use the S-C-R (**S**ituation-**C**omplication-**R**esolution) framework to think through the introduction. Limit the introduction to what the reader will readily agree is true. Always put the historical chronology in the introduction. **What happened should not be in the body. The body should hold only ideas.**  

## Summary
The pryamid structure is forcing me to think about all the messages to convey before writing the document. As a result, how I write my chats, emails, or vision documents is changing. I am moving from "I don't like writing" to "I like writing." I find the following items most useful:  
...
-	Use the Situation, Complication, and Resolution framework for introduction and revise the pyramid if necessary. Tell a story using the S-C-R framework.
-	Lead with the answer. Then, state the key-line messages and provide the supporting details. Establish a question/answer dialog with the reader, controlling the sequence of the ideas. 

For each step in the hierarchy, we should know some finer points on how to do them well. I cover these in [Finer Points of Writing Clearly]({% post_url business/2022-12-12-finer-points-of-writing-clearly %}).
