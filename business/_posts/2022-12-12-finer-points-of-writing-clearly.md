...
**Inductive grouping** will take a set of similar ideas as a group, and you state the inference based on commonality among the ideas. To remember this argument, I use the following simple constructs:
